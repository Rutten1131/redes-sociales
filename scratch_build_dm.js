...
const dmBlueprint = {
  name: "RRSS - Receptor de DMs Messenger (Meta)",
  flow: [
    {
      id: 1,
      ...
      metadata: {
        designer: { x: 0, y: 0, name: "Vigilar Mensajes de Messenger" },
        restore: {
          parameters: {
            __IMTCONN__: {
    ...
    },
    {
      ...
      metadata: {
        designer: { x: 300, y: 0, name: "Enviar DM a la App" }
      }
    }
  ]
};

fs.writeFileSync('make_scenario_blueprint_inbox_receptor_dm.json', JSON.stringify(dmBlueprint, null, 2));
console.log('OK: make_scenario_blueprint_inbox_receptor_dm.json creado con exito');
